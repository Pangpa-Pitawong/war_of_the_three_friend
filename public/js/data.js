...
window.CHAR_DATA = {
  caocao: {
    ...
    skills: [
      {
        name: 'เล่ห์กล', nameEn: 'Jian Xiong (奸雄)',
        desc: 'หลังจากคุณได้รับความเสียหาย คุณอาจริบการ์ดที่ก่อความเสียหายนั้นมาเป็นของคุณ'
      },
      {
        name: 'ผู้ติดตาม', nameEn: 'Hu Jia (护驾) · เจ้านาย',
        desc: '(เจ้านาย) คุณอาจขอให้ตัวละครฝ่ายวุยก๊กใช้หรือเล่น [หลบหลีก] แทนคุณได้ หากพวกเขายินยอม (ถือว่าคุณเป็นผู้ใช้หรือเล่น [หลบหลีก] นั้น)'
      }
    ]
  },
  simayi: {
    ...
    skills: [
      {
        name: 'การโต้กลับ', nameEn: 'Fan Kui (反馈)',
        desc: 'หลังจากคุณได้รับความเสียหาย คุณอาจริบการ์ด 1 ใบจากตัวละครที่ก่อความเสียหายนั้น'
      },
      {
        name: 'เนโครแมนซี', nameEn: 'Gui Cai (鬼才)',
        desc: 'หลังจากเปิดการ์ดตัดสิน คุณอาจทิ้งการ์ด 1 ใบจากมือ การ์ดที่ทิ้งนั้นจะกลายเป็นการ์ดตัดสินใบใหม่'
      }
    ]
  },
  zhangliao: {
    ...
    skills: [
      {
        name: 'การโจมตีฉับพลัน', nameEn: 'Tu Xi (突袭)',
        desc: 'ช่วงจั่วการ์ด คุณอาจเลือกไม่จั่วการ์ดจากกอง แล้วเลือกตัวละครสูงสุด 2 คน ริบการ์ด 1 ใบจากมือของแต่ละคนแทน'
      }
    ]
  },
  xiahou: {
    ...
    skills: [
      {
        name: 'ความแน่วแน่', nameEn: 'Gang Lie (刚烈)',
        desc: 'หลังจากคุณได้รับความเสียหาย คุณอาจเข้าสู่ช่วงตัดสิน ถ้าการ์ดตัดสินไม่ใช่สัญลักษณ์ ♥ (หัวใจ) ผู้ก่อความเสียหายต้องเลือก: ①ทิ้งการ์ดในมือ 2 ใบ หรือ ②รับความเสียหายจากคุณ 1 หน่วย'
      }
    ]
  },
  xuzhu: {
    ...
    skills: [
      {
        name: 'เปลือยกายอุกอาจ', nameEn: 'Luo Yi (裸衣)',
        desc: 'ช่วงจั่วการ์ด คุณอาจเลือกจั่วการ์ดน้อยลง 1 ใบ ถ้าทำเช่นนั้น [โจมตี] หรือ [ประลอง] ของคุณในเทิร์นนี้จะสร้างความเสียหายเพิ่ม 1 หน่วย'
      }
    ]
  },
  zhenji: {
    ...
    skills: [
      {
        name: 'พระพันปีหลวง', nameEn: 'Qing Guo (倾国)',
        desc: 'คุณอาจใช้หรือเล่นการ์ดสีดำแทน [หลบหลีก] ได้'
      },
      {
        name: 'เทพีแห่งแม่น้ำลั่ว', nameEn: 'Luo Shen (洛神)',
        desc: 'ช่วงเตรียมตัว คุณอาจเข้าสู่ช่วงตัดสิน ถ้าการ์ดตัดสินเป็นสีดำ คุณริบการ์ดนั้นมาเป็นของคุณ และคุณอาจทำซ้ำขั้นตอนนี้ต่อไปได้ตราบใดที่การ์ดตัดสินยังเป็นสีดำ'
      }
    ]
  },
  guojia: {
    ...
    skills: [
      {
        name: 'ความหึงหวงของสวรรค์', nameEn: 'Tian Du (天妒)',
        desc: 'หลังจากการ์ดตัดสินของคุณมีผล คุณอาจริบการ์ดนั้นมาเป็นของคุณ'
      },
      {
        name: 'มรดกตกทอด', nameEn: 'Yi Ji (遗计)',
        desc: 'หลังจากคุณได้รับความเสียหาย 1 หน่วย คุณอาจดูการ์ด 2 ใบบนสุดของกอง แล้วมอบให้ตัวละครใดก็ได้ (รวมถึงตัวเอง)'
      }
    ]
  },
  yuejin: {
    ...
    skills: [
      {
        name: 'ไม่หวั่นเกรง', nameEn: 'Xiao Guo (骁果)',
        desc: 'ช่วงท้ายเทิร์นของตัวละครอื่น คุณอาจทิ้งการ์ดพื้นฐาน 1 ใบ เพื่อให้เป้าหมายทิ้งการ์ดอุปกรณ์ 1 ใบ มิฉะนั้นคุณสร้างความเสียหาย 1 หน่วยให้ตัวละครนั้น'
      }
    ]
  },
  liubei: {
    ...
    skills: [
      {
        name: 'เมตตาธรรม', nameEn: 'Ren De (仁德)',
        desc: 'ช่วงเล่นการ์ด คุณอาจมอบการ์ดในมือจำนวนเท่าใดก็ได้ให้ตัวละครอื่น และฟื้น HP 1 หน่วยถ้ามอบไป 2 ใบขึ้นไป'
      },
      {
        name: 'อิทธิพล', nameEn: 'Ji Jiang (激将) · เจ้านาย',
        desc: '(เจ้านาย) คุณอาจขอให้ตัวละครฝ่ายจ๊กก๊กใช้หรือเล่น [โจมตี] แทนคุณได้ หากพวกเขายินยอม (คุณจะถูกถือว่าเป็นแหล่งที่มาของความเสียหาย)'
      }
    ]
  },
  guanyu: {
    ...
    skills: [
      {
        name: 'เทพแห่งสงคราม', nameEn: 'Wu Sheng (武圣)',
        desc: 'คุณอาจใช้หรือเล่นการ์ดสีแดงแทน [โจมตี] ได้'
      }
    ]
  },
  zhangfei: {
    ...
    skills: [
      {
        name: 'เสียงโห่ร้องศึก', nameEn: 'Pao Xiao (咆哮) · Passive',
        desc: 'คุณอาจใช้การ์ด [โจมตี] ได้ไม่จำกัดจำนวน'
      }
    ]
  },
  zhaoyun: {
    ...
    skills: [
      {
        name: 'ใจกล้าหาญ', nameEn: 'Long Dan (龙胆)',
        desc: 'คุณอาจใช้หรือเล่น [โจมตี] แทน [หลบหลีก] หรือ [หลบหลีก] แทน [โจมตี] ได้'
      }
    ]
  },
  zhuge: {
    ...
    skills: [
      {
        ...
        desc: 'ช่วงเตรียมตัว คุณอาจดูการ์ด X ใบจากบนสุดของกอง (X = จำนวนตัวละครทั้งหมดในเกม สูงสุด 5) แล้ววางการ์ดจำนวนเท่าใดก็ได้กลับไปบนกองตามลำดับที่ต้องการ และวางการ์ดที่เหลือไว้ที่ก้นกอง'
      },
      {
        name: 'กลยุทธ์ป้อมปราการเปล่า', nameEn: 'Kong Cheng (空城) · Passive',
        desc: 'คุณจะไม่ถูกเลือกเป็นเป้าหมายของ [โจมตี] หรือ [ประลอง] ได้ ถ้าคุณไม่มีการ์ดในมือ'
      }
    ]
  },
  machao: {
    ...
    skills: [
      {
        name: 'การขี่ม้า', nameEn: 'Ma Shu (马术) · Passive',
        desc: 'ลดระยะห่างระหว่างคุณกับตัวละครอื่นลง 1'
      },
      {
        name: 'ทแกล้วทหารม้า', nameEn: 'Tie Ji (铁骑)',
        desc: 'คุณอาจเข้าสู่ช่วงตัดสินเมื่อใช้ [โจมตี] กับเป้าหมาย ถ้าการ์ดตัดสินเป็นสีแดง เป้าหมายจะไม่สามารถใช้ [หลบหลีก] ได้'
      }
    ]
  },
  huangyy: {
    ...
    skills: [
      {
        name: 'บ่มเพาะปัญญา', nameEn: 'Ji Zhi (集智)',
        desc: 'คุณอาจจั่วการ์ด 1 ใบหลังจากใช้การ์ดประเภทยุทธวิธี'
      },
      {
        name: 'เวทมนตร์', nameEn: 'Qi Cai (奇才) · Passive',
        desc: 'การ์ดยุทธวิธีของคุณมีระยะไม่จำกัด'
      }
    ]
  },
  ladygan: {
    ...
    skills: [
      {
        name: 'ปัญญาประเสริฐ', nameEn: 'Shu Shen (淑慎)',
        desc: 'ช่วงต้นเทิร์นของคุณ คุณอาจทิ้งการ์ดในมือทั้งหมด และฟื้น HP 1 หน่วยถ้าจำนวนการ์ดที่ทิ้งมากกว่า HP ของคุณ'
      },
      {
        name: 'ความรอบคอบ', nameEn: 'Shen Zhi (神智)',
        desc: 'เมื่อคุณฟื้น HP คุณอาจเลือกตัวละครอื่นให้จั่วการ์ด 1 ใบ และจั่ว 2 ใบถ้าตัวละครนั้นไม่มีการ์ดในมือเลยในขณะนั้น'
      }
    ]
  },
  sunquan: {
    ...
    skills: [
      {
        name: 'ความสมดุล', nameEn: 'Zhi Heng (制衡)',
        desc: 'จำกัด 1 ครั้งต่อช่วงเล่นการ์ด คุณอาจทิ้งการ์ดจำนวนเท่าใดก็ได้ แล้วจั่วการ์ดจำนวนเท่ากันมาแทน'
      },
      {
        name: 'ความปลดปล่อย', nameEn: 'Jiu Yuan (救援) · เจ้านาย Passive',
        desc: '(เจ้านาย) คุณจะฟื้น HP เพิ่มอีก 1 หน่วย เมื่อมีตัวละครฝ่ายง่อก๊กใช้ [ลูกท้อ] กับคุณ'
      }
    ]
  },
  zhouyu: {
    ...
    skills: [
      {
        name: 'กล้าหาญ', nameEn: 'Ying Zi (英姿)',
        desc: 'ช่วงจั่วการ์ด คุณอาจจั่วการ์ดเพิ่มอีก 1 ใบ'
      },
      {
        name: 'หว่านเมล็ดแห่งความหวาดระแวง', nameEn: 'Fan Jian (反间)',
        desc: 'จำกัด 1 ครั้งต่อช่วงเล่นการ์ด คุณอาจเลือกตัวละครให้เลือกชนิดการ์ด (suit) จากนั้นตัวละครนั้นจั่วการ์ด 1 ใบจากมือคุณแล้วเปิดเผย เป้าหมายจะได้รับความเสียหาย 1 หน่วยถ้าการ์ดที่เปิดเผยมีชนิดต่างจากที่เลือกไว้ (เป้าหมายจะได้เก็บการ์ดจากมือคุณไว้ไม่ว่าผลจะเป็นอย่างไร)'
      }
    ]
  },
  huanggai: {
    ...
    skills: [
      {
        name: 'เสียสละตน', nameEn: 'Ku Rou (苦肉)',
        desc: 'ช่วงเล่นการ์ด คุณอาจเลือกเสีย HP 1 หน่วยเพื่อจั่วการ์ด 2 ใบ'
      }
    ]
  },
  luxun: {
    ...
    skills: [
      {
        name: 'ความสุขุมถ่อมตน', nameEn: 'Qian Xun (谦逊) · Passive',
        desc: 'คุณไม่สามารถตกเป็นเป้าหมายของ [ขโมย] และ [มัวเมา] ได้'
      },
      {
        name: 'ลมหายใจครั้งที่สอง', nameEn: 'Lian Ying (连营)',
        desc: 'คุณอาจจั่วการ์ด 1 ใบเมื่อคุณเสียการ์ดในมือใบสุดท้ายไป'
      }
    ]
  },
  sunss: {
    ...
    skills: [
      {
        name: 'การสมรส', nameEn: 'Jie Yin (结姻)',
        desc: 'จำกัด 1 ครั้งต่อช่วงเล่นการ์ด คุณอาจเลือกตัวละครชายที่บาดเจ็บ แล้วทิ้งการ์ด 2 ใบจากมือของคุณ เพื่อให้ทั้งคุณและตัวละครชายที่เลือกฟื้น HP 1 หน่วยทั้งคู่'
      },
      {
        name: 'ความบ้าบิ่น', nameEn: 'Xiao Ji (枭姬)',
        desc: 'คุณอาจจั่วการ์ด 2 ใบเมื่อคุณสูญเสียอุปกรณ์ที่สวมอยู่'
      }
    ]
  },
  lvmeng: {
    ...
    skills: [
      {
        name: 'ความสงบนิ่ง', nameEn: 'Ke Ji (克己)',
        desc: 'คุณอาจข้ามช่วงทิ้งการ์ดได้ ถ้าคุณไม่ได้ใช้หรือเล่น [โจมตี] ในเทิร์นของคุณ'
      }
    ]
  },
  ganning: {
    ...
    skills: [
      {
        name: 'การจู่โจมซุ่มซ่อน', nameEn: 'Qi Xi (奇袭)',
        desc: 'คุณอาจใช้การ์ดสีดำแทน [เผาสะพาน] ได้'
      }
    ]
  },
  daqiao: {
    ...
    skills: [
      {
        name: 'เสน่ห์ดึงดูด', nameEn: 'Guo Se (国色)',
        desc: 'คุณอาจใช้การ์ดสัญลักษณ์ ♦ (ข้าวหลามตัด) แทน [มัวเมา] ได้'
      },
      {
        name: 'เบี่ยงเบี่ยง', nameEn: 'Liu Li (流离)',
        desc: 'เมื่อคุณตกเป็นเป้าหมายของ [โจมตี] คุณอาจทิ้งการ์ด 1 ใบเพื่อโยกย้าย [โจมตี] นี้ไปยังตัวละครอื่นที่อยู่ในระยะโจมตีของคุณ (ยกเว้นตัวละครที่เล่น [โจมตี] นั้น)'
      }
    ]
  },
  lvbu: {
    ...
    skills: [
      {
        name: 'ไม่มีผู้ใดเทียบได้', nameEn: 'Wu Shuang (无双) · Passive',
        desc: 'ตัวละครอื่นต้องเล่น [หลบหลีก] 2 ใบเพื่อหักล้าง [โจมตี] ของคุณ และตัวละครที่ [ประลอง] กับคุณต้องเล่น [โจมตี] 2 ใบทุกครั้งที่ต้องใช้'
      }
    ]
  },
  diaochan: {
    ...
    skills: [
      {
        name: 'เสน่ห์มารยา', nameEn: 'Li Jian (离间)',
        desc: 'จำกัด 1 ครั้งต่อช่วงเล่นการ์ด ทิ้งการ์ด 1 ใบเพื่อเลือกตัวละครชาย 2 คนให้ [ประลอง] กัน (①คุณเป็นผู้กำหนดว่าใครจะเล่น [โจมตี] ก่อน; ②ไม่สามารถถูกยกเลิกด้วย [ขัดขวาง] ได้)'
      },
      {
        name: 'ความงามที่บังแสงจันทร์', nameEn: 'Bi Yue (闭月)',
        desc: 'ช่วงท้ายเทิร์น คุณอาจจั่วการ์ด 1 ใบ'
      }
    ]
  },
  huatuo: {
    ...
    skills: [
      {
        name: 'ปฐมพยาบาล', nameEn: 'Jiu Ji (急救)',
        desc: 'คุณอาจใช้การ์ดสีแดงแทน [ลูกท้อ] ได้ในเทิร์นของผู้อื่น'
      },
      {
        name: 'หมอผู้เมตตา', nameEn: 'Qing Nang (青囊)',
  ...
  huaxiong: {
    ...
    kingdom: 'QUN', hp: 6, difficulty: 2,
    image: '/GeneralCard/QUH/Hua Xiong.png',
    lore: 'แม่ทัพที่กล้าหาญของตงจัว ผู้ถูกกวนอูสังหารขณะไวน์ยังร้อน',
    skills: [
      {
        name: 'ผู้พิชิต', nameEn: 'Conqueror · Passive',
        desc: 'เมื่อตัวละครใดสร้างความเสียหายให้คุณด้วย [โจมตี] สีแดง ตัวละครนั้นอาจฟื้น HP 1 หน่วย หรือจั่วการ์ด 1 ใบ'
      }
    ]
  },
  gongsuanzan: {
    ...
    skills: [
      {
        name: 'กองกำลังราษฎร', nameEn: 'Yi Cong (义从) · Passive',
        desc: 'เมื่อ HP คุณมากกว่า 2 ให้ลดระยะห่างระหว่างคุณกับตัวละครอื่นลง 1; เมื่อ HP คุณน้อยกว่าหรือเท่ากับ 2 ตัวละครอื่นจะเพิ่มระยะห่างระหว่างพวกเขากับคุณขึ้น 1'
      }
    ]
  },
  panfeng: {
    ...
    skills: [
      {
        name: 'ขวานแห่งความบ้าคลั่ง', nameEn: 'Kuang Fu (狂斧) · Passive',
        desc: 'จำกัด 1 ครั้งต่อช่วงเล่นการ์ด หลังจาก [โจมตี] ของคุณสร้างความเสียหายให้ตัวละครอื่น ถ้า HP ของฝ่ายนั้นน้อยกว่าคุณ ให้จั่วการ์ด 2 ใบ; ถ้า HP มากกว่าหรือเท่ากับคุณ คุณเสีย HP 1 หน่วย'
      }
    ]
  },
};
...
window.CARD_DATA = {
  'Attack': {
    ...
    color: '#c0392b',
    desc: 'สร้างความเสียหาย 1 หน่วยให้เป้าหมายในระยะ เป้าหมายสามารถเล่น [หลบหลีก] เพื่อหักล้างได้',
  ...
  'Dodge': {
    ...
    color: '#2980b9',
    desc: 'หักล้าง [โจมตี] ที่เล่นมาหาคุณ',
  ...
  'Peach': {
    ...
    color: '#e91e8c',
    desc: 'ฟื้น HP 1 หน่วย ใช้ได้เฉพาะในช่วงเล่นการ์ดของตน หรือเมื่อผู้เล่นคนใดกำลังจะตาย',
  ...
  'Duel': {
    ...
    color: '#8e44ad',
    desc: 'ผลัดกันเล่น [โจมตี] กับเป้าหมาย ผู้ที่เล่น [โจมตี] ไม่ได้ก่อนรับความเสียหาย 1',
  ...
  'Steal': {
    ...
    color: '#f39c12',
    desc: 'ริบการ์ด 1 ใบจากเป้าหมายในระยะ 1',
  ...
  'Burning Bridges': {
    ...
    color: '#e74c3c',
    desc: 'เลือกทิ้งการ์ด 1 ใบจากช่องอุปกรณ์/ตัดสิน/มือของเป้าหมาย',
  ...
  'Borrowed Sword': {
    ...
    color: '#16a085',
    desc: 'บังคับผู้มีอาวุธเล่น [โจมตี] ตามที่กำหนด มิฉะนั้นริบอาวุธของเขา',
  ...
  'Raining Arrows': {
    ...
    color: '#d35400',
    desc: 'ทุกคนเล่น [หลบหลีก] มิฉะนั้นรับความเสียหาย 1',
  ...
  'Barbarian Invasion': {
    ...
    color: '#8e44ad',
    desc: 'ทุกคนเล่น [โจมตี] มิฉะนั้นรับความเสียหาย 1',
    usage: 'ใช้โดยไม่ต้องเลือกเป้าหมาย',
  ...
  'Bumper Harvest': {
    ...
    color: '#27ae60',
    desc: 'เปิดการ์ดจากกองตามจำนวนผู้เล่น แล้วผลัดกันเลือกเก็บคนละ 1 ใบ',
    usage: 'ใช้โดยไม่ต้องเลือกเป้าหมาย',
  ...
  'Negation': {
    ...
    color: '#7f8c8d',
    desc: 'ยกเลิกผลการ์ดยุทธวิธี หรือยกเลิก [ขัดขวาง] อื่น',
  ...
  'Overindulgence': {
    ...
    color: '#f1c40f',
    desc: 'วางในช่องตัดสินของเป้าหมาย ในช่วงตัดสิน ถ้าการ์ดที่เปิดไม่ใช่ ♥ เป้าหมายต้องข้ามช่วงเล่นการ์ด',
  ...
  'Lightning': {
    ...
    color: '#f39c12',
    desc: 'วางในช่องตัดสินของตน ในช่วงตัดสิน ถ้าการ์ดที่เปิดเป็น ♠ และค่า 2-9 รับความเสียหาย 3 ไม่งั้นส่งต่อให้คนถัดไป',
  ...
  'Zhuge Crossbow': {
    ...
    desc: 'ระยะโจมตี 1 — Passive: ผู้ถือใช้ [โจมตี] ได้ไม่จำกัดต่อเทิร์น',
  ...
  'Green Dragon Blade': {
    ...
    desc: 'ระยะโจมตี 3 — เมื่อ [โจมตี] ถูกหักล้าง อาจเล่น [โจมตี] ต่อเป้าหมายเดิมอีก',
    usage: 'ติดตั้งในช่องอาวุธ',
  ...
  'Serpent Spear': {
    ...
    desc: 'ระยะโจมตี 3 — ทิ้งการ์ด 2 ใบจากมือเพื่อสร้าง [โจมตี]',
    usage: 'ติดตั้งในช่องอาวุธ',
  ...
  'Frost Sword': {
    ...
    desc: 'ระยะโจมตี 2 [EX] — อาจยกเลิกความเสียหายจาก [โจมตี] แล้วให้เป้าหมายทิ้งการ์ด 2 ใบแทน',
    usage: 'ติดตั้งในช่องอาวุธ',
  ...
  'Blue Steel Sword': {
    ...
    desc: 'ระยะโจมตี 2 — Passive: [โจมตี] ของผู้ถือไม่ได้รับผลจากเกราะของเป้าหมาย',
    usage: 'ติดตั้งในช่องอาวุธ',
  ...
  'Rock Cleaving Axe': {
    ...
    desc: 'ระยะโจมตี 3 — ทิ้งการ์ด 2 ใบ เพื่อบังคับให้เป้าหมายรับความเสียหาย (หลบหลีกไม่ได้)',
    usage: 'ติดตั้งในช่องอาวุธ',
  ...
  'Sky Piercing Halberd': {
    ...
    desc: 'ระยะโจมตี 4 — เมื่อใช้ [โจมตี] เป็นการ์ดใบสุดท้ายในมือ สามารถเลือกเป้าหมายเพิ่มอีก 2 คน',
    usage: 'ติดตั้งในช่องอาวุธ',
  ...
  'Kirin Bow': {
    ...
    desc: 'ระยะโจมตี 5 — เมื่อ [โจมตี] สร้างความเสียหายแล้ว สามารถทิ้งการ์ดพาหนะ (ม้า) ของเป้าหมาย',
    usage: 'ติดตั้งในช่องอาวุธ',
  ...
  'Yin-Yang Swords': {
    ...
    desc: 'ระยะโจมตี 2 — เมื่อ [โจมตี] เป้าหมายเพศตรงข้าม: เป้าหมายทิ้งการ์ด 1 ใบ หรือคุณจั่ว 1 ใบ',
    usage: 'ติดตั้งในช่องอาวุธ',
  ...
  'Eight Trigrams Formation': {
    ...
    color: '#e17055',
    desc: 'เกราะ — เข้าช่วงตัดสินเมื่อต้องใช้/เล่น [หลบหลีก]; ถ้าการ์ดที่เปิดเป็นสีแดง ถือว่าใช้ [หลบหลีก] แล้ว',
  ...
  'Nio Shield': {
    ...
    color: '#636e72',
    desc: 'เกราะ [EX] — Passive: ภูมิคุ้มกันต่อ [โจมตี] สีดำ',
    usage: 'ติดตั้งในช่องเกราะ',
  ...
  'Shadowrunner': {
    nameTh: 'ม้าเงาราตรี +1 (绝影)', nameEn: 'Shadowrunner', type: 'mount',
    color: '#2d3436',
    desc: 'ม้าโจมตี (+1) — เพิ่มระยะโจมตีของคุณไปยังผู้อื่น 1',
...
window.ROLE_DATA = {
  ...
  'Loyalist': {
    ...
    goal: 'ปกป้องจักรพรรดิและกำจัดกบฎ+ทรยศ',
